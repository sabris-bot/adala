...
export const initialRequestsSeed: EmployeeRequest[] = [
    ...
    // 2. طلب سلفة (Salary Advance)
    {
        ...
        approvals: [
            ...
            { roleId: 'legal', roleAr: 'الإدارة القانونية', roleEn: 'Legal Administration', status: 'pending', notes: 'في انتظار توقيع التعهد بالسداد الخارجي.' },
    ...
    // 4. طلب انتداب (Deputation)
    {
        ...
        nationality: 'كويتي',
        civilId: '293040400321',
        reasonNote: 'طلب انتداب ومهمة عمل رسمية لبحث وإنهاء وتوثيق العقود الأجنبية للشركات المستفيدة بالتنسيق المباشر مع مكاتب الدولة.',
        approvals: [
            { roleId: 'applicant', roleAr: 'مقدم الطلب', roleEn: 'Applicant', status: 'approved', approverName: 'بدر فهد المطيري', actionDate: '2026-05-29', notes: 'طلب انتداب رسمي.' },
            { roleId: 'line_manager', roleAr: 'المدير المباشر', roleEn: 'Direct Manager', status: 'pending', notes: 'قيد التقييم والمطابقة مع سعة الباحثين الحاليين بالقسم.' },
            { roleId: 'hr', roleAr: 'الموارد البشرية', roleEn: 'Human Resources', status: 'pending', notes: 'بانتظار رأي الإدارة المباشرة.' },
            { roleId: 'finance', roleAr: 'الإدارة المالية', roleEn: 'Financial Administration', status: 'pending', notes: 'بانتظار رصد المخصص اليومي للبدلات.' },
            { roleId: 'legal', roleAr: 'الإدارة القانونية', roleEn: 'Legal Administration', status: 'pending', notes: 'بانتظار فحص الامتثال.' },
            { roleId: 'final_approval', roleAr: 'الاعتماد النهائي', roleEn: 'Final Approval', status: 'pending', notes: 'للمصادقة الكلية.' }
        ]
    },
    // 5. تظلم إداري (Grievance Form)
    {
        id: 'ad-req-5',
        employeeId: 'emp-2',
        ...
        employeeDepartment: 'العمليات',
        requestType: RequestType.CUSTOM, // Or Custom Form
        requestDate: '2026-05-18',
        status: 'Under HR Review',
        referenceNumber: 'QA-REQ-2026-005',
        customTitle: 'تظلم بخصوص خصومات الغياب وعقوبة التنبيه الثاني',
        customContent: 'أرجو التكرم بإعادة مراجعة ولائحة الخصم الواقعة علي بقيمة 3 أيام غياب، حيث أنني كنت مرافقة لأخي في عملية طبية طارئة بمستشفى جابر المسلح ولدي مستند ومذكرة رسمية تثبت ذلك.',
        warningsCountAtRequest: 2,
        outstandingLoansCount: 0,
        hasActiveInvestigation: true, // Special Legal Warning Flag
        remainingLeaveDays: 4,
        joiningDate: '2022-09-12',
        nationality: 'كويتية',
        civilId: '295050500456',
        reasonNote: 'تظلم رسمي لتسوية العقوبات والجزاءات التأديبية المسجلة بالملف نظراً لوجود مبرر قانوني رسمي وقاهر.',
        approvals: [
            { roleId: 'applicant', roleAr: 'مقدم الطلب', roleEn: 'Applicant', status: 'approved', approverName: 'سحر جاسم الفيلي', actionDate: '2026-05-18', notes: 'تظلم بطلب إلغاء الخصم الوارد.' },
            { roleId: 'line_manager', roleAr: 'المدير المباشر', roleEn: 'Direct Manager', status: 'rejected', approverName: 'أنس المطوع', actionDate: '2026-05-19', notes: 'الموظفة أخلت بالالتزام العقد ولم تقم بإبلاغنا كتابة مسبقاً.' },
            { roleId: 'hr', roleAr: 'الموارد البشرية', roleEn: 'Human Resources', status: 'pending', notes: 'شؤون الموظفين تنسق مع الشؤون القانونية لعقد جلسة تحقيق وسماع أقوال لإلغاء أو تثبيت العقوبة.' },
            { roleId: 'finance', roleAr: 'الإدارة المالية', roleEn: 'Financial Administration', status: 'pending', notes: 'بانتظار الرأي القانوني لتسوية الخصم بالرواتب.' },
            { roleId: 'legal', roleAr: 'الإدارة القانونية', roleEn: 'Legal Administration', status: 'pending', notes: 'عقوبات مادة 41 وما يتعلق بها تستلزم تحقيقاً كتابياً رسمياً مكفولاً بالحقوق.' },
            { roleId: 'final_approval', roleAr: 'الاعتماد النهائي', roleEn: 'Final Approval', status: 'pending', notes: 'تحت المجهر شريكي.' }
        ]
    }
];
