...
export const BrainIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-3.758-3.848 5.25 5.25 0 00-10.233 2.33A4.502 4.502 0 002.25 15z" />); // Actually CloudIcon, used as placeholder for AI/Brain
...
export const GavelIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />); // Actually DB icon, used as Gavel placeholder
...
export const CalculatorIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75l-2.489-2.489m0 0a3.375 3.375 0 10-4.773-4.773 3.375 3.375 0 004.774 4.774zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />);
...
export const WrenchScrewdriverIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />); // Actually Envelope/Mail for Wrench fallback as I don't have exact path, but let's use a wrench-like path if possible or generic tool
...
export const IdentificationIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 11-3.75 0 1.875 1.875 0 013.75 0zm1.294 6.336a6.721 6.721 0 01-1.294-1.579 6.721 6.721 0 01-1.294 1.579 5.25 5.25 0 00-4.5 4.043V17.25h11.5v-.5a5.25 5.25 0 00-4.5-4.043z" />);
...
export const UserTieIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />); // Approximate
...
export const TrendingDownIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 0111.818 10.968" />); // Approximated
...
export const Squares2X2Icon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6h4.5m-.75 3h.75M3.75 15h4.5m-.75 3h.75m9-12h4.5m-.75 3h.75m-3.75 9h4.5m-.75 3h.75M9 3.75h6m-3 .75v-.75m0 0v1.5m-9 9h6m-3 .75v-.75m0 0v1.5m9 3h6m-3 .75v-.75m0 0v1.5" />); // Square layout icon placeholder
...
export const PuzzlePieceIcon = createIcon(<path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.08V4.5a2.25 2.25 0 00-4.5 0v1.58c0 .13.02.26.07.38a2.25 2.25 0 01-1.97 3.04 2.25 2.25 0 01-2.44-2.07 2.25 2.25 0 00-2.25-2.18h-1.5a2.25 2.25 0 00-2.25 2.25v1.5a2.25 2.25 0 002.25 2.25h.06c.13 0 .26.02.38.07a2.25 2.25 0 011.04 3.12 2.25 2.25 0 01-3.12 1.04 2.25 2.25 0 00-2.18-2.25v1.5a2.25 2.25 0 002.25 2.25h1.5a2.25 2.25 0 002.25-2.25v-.06c0-.13.02-.26.07-.38a2.25 2.25 0 013.12-1.04 2.25 2.25 0 011.04 3.12 2.25 2.25 0 002.25 2.18h1.5a2.25 2.25 0 002.25-2.25v-1.5a2.25 2.25 0 00-2.25-2.25h-.06c-.13 0-.26-.02-.38-.07a2.25 2.25 0 01-1.04-3.12 2.25 2.25 0 013.12-1.04 2.25 2.25 0 002.18 2.25v-1.5a2.25 2.25 0 00-2.25-2.25h-1.5a2.25 2.25 0 00-2.25 2.25v.06c0 .13-.02.26-.07.38a2.25 2.25 0 01-3.12 1.04 2.25 2.25 0 01-1.04-3.12 2.25 2.25 0 00-2.25-2.18h1.5a2.25 2.25 0 002.25-2.25v-1.5a2.25 2.25 0 00-2.25-2.25h-.06c-.13 0-.26-.02-.38-.07a2.25 2.25 0 01-1.04-3.12 2.25 2.25 0 013.12-1.04 2.25 2.25 0 002.18 2.25v1.5a2.25 2.25 0 002.25 2.25z" />); // Approximate path
...
export const JURISDICTIONS: Jurisdiction[] = [
  {
    ...
    laborLaw: {
      ...
      disciplinaryRules: {
        ...
        appealPeriodDays: 15,
        rules: [
            { article: '26', text: 'لا يجوز توقيع جزاء على العامل إلا بعد إبلاغه كتابة بما هو منسوب إليه وسماع أقواله وتحقيق دفاعه وإثبات ذلك في محضر يودع بملفه الخاص.' },
            { article: '25', text: 'يجب ألا يوقع الجزاء بعد مضي 15 يوماً من تاريخ ثبوت المخالفة.' },
            { article: '28', text: 'لا يجوز توقيع أكثر من جزاء واحد عن المخالفة الواحدة.' },
            { article: '29', text: 'للعامل الحق في التظلم من قرار الجزاء أمام الدائرة العمالية المختصة.' },
            { article: '41', text: 'يجوز لصاحب العمل فصل العامل دون إنذار أو مكافأة في حالة الخطأ الجسيم (مثل إفشاء الأسرار، الاعتداء، الغياب المتصل 7 أيام...).' }
        ]
      }
    }
  },
  ...
  },
  {
    ...
    laborLaw: {
      ...
      indemnityRules: {
        ...
        subsequentPeriodDaysPerYear: 30,
        maxIndemnityMonths: 24,
        resignationAdjustment: {
          under3Years: 1, // Multipliers depend on contract type (Limited/Unlimited)
          threeToFiveYears: 1,
          fiveToTenYears: 1,
          overTenYears: 1
        }
...
export const NAVIGATION_ITEMS: NavItem[] = [
  { name: 'الرئيسية', translationKey: 'dashboard', path: '/dashboard', icon: ChartBarIcon },
  { name: 'القضايا', translationKey: 'cases', path: '/cases', icon: BriefcaseIcon },
  { 
    name: 'الأدوات القانونية', 
    translationKey: 'legal_tools',
    path: '/tools', 
    icon: WrenchScrewdriverIcon,
    children: [
        { name: 'حاسبة المواعيد', translationKey: 'deadlines_calc', path: '/tools/legal-deadlines', icon: ClockIcon },
        { name: 'حاسبة الرسوم', translationKey: 'fees_calc', path: '/tools/court-fees', icon: CalculatorIcon },
        { name: 'حاسبة الفوائد القانونية', translationKey: 'interest_calc', path: '/tools/legal-interests', icon: ScaleIcon },
        { name: 'النماذج والصيغ', translationKey: 'legal_forms', path: '/legal-forms', icon: DocumentDuplicateIcon },
        { name: 'المكتبة القانونية', translationKey: 'legal_library', path: '/resources', icon: BookOpenIcon },
        { name: 'حاسبة المواريث', translationKey: 'inheritance_calc', path: '/tools/inheritance', icon: UsersIcon },
    ]
  },
  { 
    name: 'شؤون الموظفين', 
    ...
    children: [
        ...
        { name: 'القروض والسلف', translationKey: 'loans', path: '/employee-affairs/loans', icon: CurrencyDollarIcon },
        { name: 'الإجراءات التأديبية', translationKey: 'disciplinary', path: '/employee-affairs/disciplinary', icon: ExclamationTriangleIcon },
        { name: 'التحقيقات', translationKey: 'investigations', path: '/employee-affairs/investigations', icon: GavelIcon },
        { name: 'الطلبات الإدارية', translationKey: 'employee_requests', path: '/employee-affairs/requests', icon: ChatBubbleLeftEllipsisIcon },
    ]
  },
  {
    name: 'إدارة العقارات',
    ...
    sectionHeader: 'إدارة الأصول',
    sectionTranslationKey: 'asset_management'
  },
  {
    name: 'الشؤون المالية',
  ...
  {
    name: 'الأدوات الذكية',
    translationKey: 'smart_tools',
    path: '/smart-tools',
    icon: SparklesIcon,
    children: [
        { name: 'المساعد الذكي (AI)', translationKey: 'ai_assistant', path: '/ai-assistant', icon: SparklesIcon },
        { name: 'الخرائط الذهنية', translationKey: 'mind_maps', path: '/smart-mind-maps', icon: BrainIcon },
        { name: 'تحليل العقود', translationKey: 'contract_analysis', path: '/contracts', icon: ClipboardListCheckIcon },
    ]
  },
  {
    name: 'إدارة التقاضي',
    ...
    icon: GavelIcon,
    sectionHeader: 'أدوات التقاضي',
    sectionTranslationKey: 'litigation_tools',
    children: [
        ...
        { name: 'تتبع المهام والأطراف', translationKey: 'party_tracking', path: '/party-tracking', icon: MapPinIcon },
  ...
  },
  {
    ...
    children: [
        ...
        { name: 'التقارير', translationKey: 'reports', path: '/reports', icon: PresentationChartLineIcon },
        { name: 'الامتثال', translationKey: 'compliance', path: '/compliance', icon: ShieldCheckIcon },
        { name: 'الإعدادات', translationKey: 'settings', path: '/settings', icon: CogIcon },
    ]
  }
];

// --- INVESTIGATION TEMPLATES (EXPANDED) ---
export const INVESTIGATION_TEMPLATES = [
    {
        id: 'absenteeism',
        title: 'تحقيق غياب بدون إذن',
        questions: [
            'ما هو سبب غيابك عن العمل يوم (...)؟',
            'هل قمت بإبلاغ رئيسك المباشر أو أي مسؤول في الشركة قبل الغياب؟',
            'هل لديك أي مستندات أو تقارير طبية تبرر هذا الغياب؟',
            'هل أنت على علم بأن الغياب بدون إذن يعتبر مخالفة للائحة العمل؟'
        ]
    },
    {
        id: 'negligence',
        title: 'تحقيق في إهمال وظيفي / خطأ مهني',
        questions: [
            'ما هي مهامك الوظيفية المحددة في هذا الشأن؟',
            'كيف وقع الخطأ المذكور في التقرير؟',
            'هل اتبعت الإجراءات واللوائح المعتمدة لتنفيذ العمل؟',
            'هل تدرك الأضرار التي ترتبت على هذا الخطأ؟'
        ]
    },
    {
        id: 'misconduct',
        title: 'تحقيق في سوء سلوك / مشادة كلامية',
        questions: [
            'يرجى سرد تفاصيل الواقعة التي حدثت يوم (...) مع الزميل/المدير.',
            'ما هي الألفاظ أو التصرفات التي بدرت منك تحديداً؟',
            'هل كان هناك شهود على الواقعة؟',
            'هل هناك أي أسباب أو استفزازات سابقة أدت إلى هذا التصرف؟'
        ]
    },
    {
        id: 'confidentiality',
        title: 'تحقيق في إفشاء أسرار العمل',
        questions: [
            'هل قمت بمشاركة معلومات (...) مع أي طرف خارجي؟',
            'من صرح لك بتداول هذه المعلومات؟',
            'هل أنت على علم بسياسة سرية المعلومات وتوقيعك على اتفاقية عدم الإفصاح؟',
            'هل تمانع في فحص سجلات الاتصال الخاصة بالعمل للتحقق؟'
        ]
    },
    {
        id: 'theft_embezzlement',
        title: 'تحقيق عجز مالي / اختلاس',
        questions: [
            'ما هي طبيعة عملك وصلاحياتك المالية في هذا القسم؟',
            'متى اكتشفت العجز المالي في العهدة؟',
            'هل يشاركك أحد في استخدام الخزينة أو النظام المالي؟',
            'كيف تفسر وجود هذا النقص في الأموال المقيدة بعهدتك؟',
            'هل لديك أي مستندات تثبت أوجه صرف هذه المبالغ المفقودة؟'
        ]
    },
    {
        id: 'insubordination',
        title: 'عدم تنفيذ أوامر (عصيان إداري)',
        questions: [
            'هل تسلمت التوجيه الصادر من مديرك المباشر بخصوص (...) بتاريخ (...)؟',
            'لماذا امتنعت عن تنفيذ هذا الأمر الإداري المباشر؟',
            'هل تعلم أن رفض تنفيذ الأوامر المشروعة يعد مخالفة للائحة العمل؟',
            'هل هناك عائق مادي أو قانوني منعك من التنفيذ؟'
        ]
    },
    {
        id: 'forgery',
        title: 'تزوير مستندات / بصمة',
        questions: [
            'كيف تفسر عدم تطابق البيانات في المستند (...) مع السجلات الرسمية؟',
            'هل قمت بإعطاء بطاقتك الوظيفية أو رقمك السري لأي زميل آخر؟',
            'هل تعلم أن التزوير في المحررات الرسمية جريمة يعاقب عليها القانون الجنائي والإداري؟',
            'ما هو ردك على تقرير الخبير الفني الذي يثبت التلاعب؟'
        ]
    },
    {
        id: 'property_damage',
        title: 'إتلاف ممتلكات الشركة',
        questions: [
            'صف لنا كيف حدث التلف في الجهاز/المعدة (...)؟',
            'هل كان هذا الإتلاف ناتجاً عن إهمال أم أنه حادث عرضي خارج عن إرادتك؟',
            'هل اتبعت إجراءات التشغيل والسلامة المعتمدة عند استخدام الجهاز؟',
            'هل قمت بالإبلاغ عن الحادث فور وقوعه؟'
        ]
    },
    {
        id: 'harassment',
        title: 'شكوى تحرش / مضايقة',
        questions: [
            'يرجى سرد تفاصيل الواقعة (القولية أو الفعلية) التي حدثت.',
            'أين ومتى حدثت الواقعة تحديداً؟',
            'هل هناك شهود أو أدلة (رسائل، تسجيلات) تدعم أقوالك؟',
            'هل سبق وأن صدرت تصرفات مماثلة من نفس الشخص تجاهك؟'
        ]
    }
];

// --- LEGAL RULES (Labor Law) - NEW ---
